...
class SquareConnect {
  ...
  public static function CreateTransaction($context, $requestObject) {
    $requestPath = '/services/squareup.connect.v3.SquareConnectV3/CreateTransaction';
    $responseWrapper = new \squareup\connect\v3\actions\CreateTransactionResponse();
    return self::sendRequest($requestPath, $context, $requestObject);
  }
  ...
  public static function RetrieveTransactionGroup($context, $requestObject) {
    $requestPath = '/services/squareup.connect.v3.SquareConnectV3/RetrieveTransactionGroup';
    $responseWrapper = new \squareup\connect\v3\actions\RetrieveTransactionGroupResponse();
    return self::sendRequest($requestPath, $context, $requestObject);
  }
