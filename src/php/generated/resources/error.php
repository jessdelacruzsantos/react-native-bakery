...
namespace squareup\connect\v3\resources\Error {
  ...
  class Type extends \DrSlump\Protobuf\Enum {
    ...
    const DELAYED_PAYMENT_EXPIRED = 40041;
    const DELAYED_PAYMENT_CANCELED = 40042;
    const CARD_TOKEN_EXPIRED = 40043;
    const CARD_TOKEN_USED = 40044;
    const AMOUNT_TOO_HIGH = 40045;
