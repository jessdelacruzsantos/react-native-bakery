...
public final class CustomerOuterClass {
  ...
  public interface CustomerOrBuilder extends
     ...
     * </pre>
     */
    java.util.List<squareup.connect.v3.resources.CardOuterClass.Card> 
        getCardsList();
    /**
     * <code>repeated .squareup.connect.v3.resources.Card cards = 6;</code>
     *
     ...
     * </pre>
     */
    squareup.connect.v3.resources.CardOuterClass.Card getCards(int index);
    /**
     * <code>repeated .squareup.connect.v3.resources.Card cards = 6;</code>
     *
     * <pre>
     ...
     * </pre>
     */
    java.util.List<? extends squareup.connect.v3.resources.CardOuterClass.CardOrBuilder> 
     ...
     * </pre>
     */
    squareup.connect.v3.resources.CardOuterClass.CardOrBuilder getCardsOrBuilder(
        int index);
  ...
  public  static final class Customer extends
          ...
          switch (tag) {
            ...
            case 50: {
              if (!((mutable_bitField0_ & 0x00000020) == 0x00000020)) {
                cards_ = new java.util.ArrayList<squareup.connect.v3.resources.CardOuterClass.Card>();
                mutable_bitField0_ |= 0x00000020;
              }
              cards_.add(input.readMessage(squareup.connect.v3.resources.CardOuterClass.Card.PARSER, extensionRegistry));
              break;
            }
            case 58: {
              com.google.protobuf.ByteString bs = input.readBytes();
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return squareup.connect.v3.resources.CustomerOuterClass.internal_static_squareup_connect_v3_resources_Customer_descriptor;
    }

    protected com.google.protobuf.GeneratedMessage.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return squareup.connect.v3.resources.CustomerOuterClass.internal_static_squareup_connect_v3_resources_Customer_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              squareup.connect.v3.resources.CustomerOuterClass.Customer.class, squareup.connect.v3.resources.CustomerOuterClass.Customer.Builder.class);
    }
    ...
    private java.util.List<squareup.connect.v3.resources.CardOuterClass.Card> cards_;
    /**
     * <code>repeated .squareup.connect.v3.resources.Card cards = 6;</code>
     *
     * <pre>
     ...
     * </pre>
     */
    public java.util.List<squareup.connect.v3.resources.CardOuterClass.Card> getCardsList() {
      return cards_;
    }
    /**
     * <code>repeated .squareup.connect.v3.resources.Card cards = 6;</code>
     ...
     * </pre>
     */
    public java.util.List<? extends squareup.connect.v3.resources.CardOuterClass.CardOrBuilder> 
        getCardsOrBuilderList() {
      return cards_;
    }
    /**
     ...
     * </pre>
     */
    public squareup.connect.v3.resources.CardOuterClass.Card getCards(int index) {
     ...
     * </pre>
     */
    public squareup.connect.v3.resources.CardOuterClass.CardOrBuilder getCardsOrBuilder(
        int index) {
      return cards_.get(index);
    }
    ...
    public static squareup.connect.v3.resources.CustomerOuterClass.Customer parseFrom(
    ...
    public static squareup.connect.v3.resources.CustomerOuterClass.Customer parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static squareup.connect.v3.resources.CustomerOuterClass.Customer parseFrom(
    ...
    public static squareup.connect.v3.resources.CustomerOuterClass.Customer parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      try {
    ...
    public static squareup.connect.v3.resources.CustomerOuterClass.Customer parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      try {
    ...
    public static squareup.connect.v3.resources.CustomerOuterClass.Customer parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
    ...
    public static Builder newBuilder(squareup.connect.v3.resources.CustomerOuterClass.Customer prototype) {
    ...
    public static final class Builder extends
        ...
        squareup.connect.v3.resources.CustomerOuterClass.CustomerOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return squareup.connect.v3.resources.CustomerOuterClass.internal_static_squareup_connect_v3_resources_Customer_descriptor;
      }
      ...
      // Construct using squareup.connect.v3.resources.CustomerOuterClass.Customer.newBuilder()
      private Builder() {
      ...
      public squareup.connect.v3.resources.CustomerOuterClass.Customer getDefaultInstanceForType() {
        return squareup.connect.v3.resources.CustomerOuterClass.Customer.getDefaultInstance();
      }

      public squareup.connect.v3.resources.CustomerOuterClass.Customer build() {
        squareup.connect.v3.resources.CustomerOuterClass.Customer result = buildPartial();
      ...
      public squareup.connect.v3.resources.CustomerOuterClass.Customer buildPartial() {
        squareup.connect.v3.resources.CustomerOuterClass.Customer result = new squareup.connect.v3.resources.CustomerOuterClass.Customer(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof squareup.connect.v3.resources.CustomerOuterClass.Customer) {
          return mergeFrom((squareup.connect.v3.resources.CustomerOuterClass.Customer)other);
        } else {
      ...
      public Builder mergeFrom(squareup.connect.v3.resources.CustomerOuterClass.Customer other) {
        if (other == squareup.connect.v3.resources.CustomerOuterClass.Customer.getDefaultInstance()) return this;
        if (other.hasId()) {
          bitField0_ |= 0x00000001;
          id_ = other.id_;
          onChanged();
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        squareup.connect.v3.resources.CustomerOuterClass.Customer parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (squareup.connect.v3.resources.CustomerOuterClass.Customer) e.getUnfinishedMessage();
          if (e.getCause() instanceof java.io.IOException) {
            throw (java.io.IOException) e.getCause();
          }
          throw e;
  ...
  bitField0_ |= 0x00000010;
      ...
      private void ensureCardsIsMutable() {
        if (!((bitField0_ & 0x00000020) == 0x00000020)) {
          cards_ = new java.util.ArrayList<squareup.connect.v3.resources.CardOuterClass.Card>(cards_);
          bitField0_ |= 0x00000020;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilder<
          squareup.connect.v3.resources.CardOuterClass.Card, squareup.connect.v3.resources.CardOuterClass.Card.Builder, squareup.connect.v3.resources.CardOuterClass.CardOrBuilder> cardsBuilder_;
      ...
      public Builder setCards(
          int index, squareup.connect.v3.resources.CardOuterClass.Card value) {
        if (cardsBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder setCards(
          int index, squareup.connect.v3.resources.CardOuterClass.Card.Builder builderForValue) {
        if (cardsBuilder_ == null) {
          ensureCardsIsMutable();
       ...
       * </pre>
       */
      public Builder addCards(squareup.connect.v3.resources.CardOuterClass.Card value) {
        if (cardsBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public Builder addAllCards(
          java.lang.Iterable<? extends squareup.connect.v3.resources.CardOuterClass.Card> values) {
        if (cardsBuilder_ == null) {
          ensureCardsIsMutable();
       ...
       * </pre>
       */
      public squareup.connect.v3.resources.CardOuterClass.Card.Builder getCardsBuilder(
          int index) {
       ...
       * </pre>
       */
      public squareup.connect.v3.resources.CardOuterClass.Card.Builder addCardsBuilder() {
        return getCardsFieldBuilder().addBuilder(
            squareup.connect.v3.resources.CardOuterClass.Card.getDefaultInstance());
      }
      /**
       * <code>repeated .squareup.connect.v3.resources.Card cards = 6;</code>
       *
      ...
      public squareup.connect.v3.resources.CardOuterClass.Card.Builder addCardsBuilder(
          int index) {
        return getCardsFieldBuilder().addBuilder(
            index, squareup.connect.v3.resources.CardOuterClass.Card.getDefaultInstance());
      }
      /**
       * <code>repeated .squareup.connect.v3.resources.Card cards = 6;</code>
       *
       ...
       * </pre>
       */
      public java.util.List<squareup.connect.v3.resources.CardOuterClass.Card.Builder> 
           getCardsBuilderList() {
  ...
  bitField0_ |= 0x00001000;
    ...
    private static final squareup.connect.v3.resources.CustomerOuterClass.Customer DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new squareup.connect.v3.resources.CustomerOuterClass.Customer();
    }

    public static squareup.connect.v3.resources.CustomerOuterClass.Customer getDefaultInstance() {
