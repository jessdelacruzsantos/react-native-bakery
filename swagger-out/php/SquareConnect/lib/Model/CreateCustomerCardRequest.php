...
class CreateCustomerCardRequest implements ArrayAccess
{
    ...
    /**
      * $card_nonce A card nonce representing the credit card to link to the customer.\n\nCard nonces are generated by the `SqPaymentForm` that buyers enter\ntheir card information into. See __Embedding the payment form__ for\nmore information.
      * @var string
      */
    protected $card_nonce;
    
    /**
      * $billing_address Address information for the card on file. Only the `postal_code`\nfield is required for payments in the US and Canada.
    ...
    /**
     * Sets card_nonce
     * @param string $card_nonce A card nonce representing the credit card to link to the customer.\n\nCard nonces are generated by the `SqPaymentForm` that buyers enter\ntheir card information into. See __Embedding the payment form__ for\nmore information.
     * @return $this
     */
     ...
     * @param \SquareConnect\Model\Address $billing_address Address information for the card on file. Only the `postal_code`\nfield is required for payments in the US and Canada.
     * @return $this
     */
